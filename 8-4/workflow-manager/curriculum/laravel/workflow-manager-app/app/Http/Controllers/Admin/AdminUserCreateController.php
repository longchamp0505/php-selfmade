...
class AdminUserCreateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'client_id' => 'nullable|string|exists:clients,id|max:50',
            'remaining_days' => 'required|integer|min:0|max:999',
            ...
            'last_year_carried' => 'required|integer|min:0|max:999',
            'before_last_taken' => 'required|integer|min:0|max:999',
        ...
        $messages = [
            ...
            'remaining_days.required' => '有給残日数は必須です。',
            'remaining_days.integer'  => '有給残日数は整数で入力してください。',
            'remaining_days.min'      => '有給残日数は0以上で入力してください。',
            'remaining_days.max'      => '有給残日数は999以下で入力してください。',
            ...
            'last_year_carried.required'  => '➌ 前年度繰越日数は必須です。',
            'before_last_taken.required'  => '➍ 一昨年度取得日数は必須です。',
        ...
        PaidLeave::create([
            ...
            'before_last_taken' => $request->before_last_taken,
